...
* На момент написания статьи [в репозитории компилятора](https://github.com/Microsoft/TypeScript) было реализовано [более 73 тысяч тестов](https://travis-ci.org/github/microsoft/TypeScript/jobs/742383268#L382).
...
`TODO:` Добавить скриншоты Developer Tools и какой-нибуль IDE
